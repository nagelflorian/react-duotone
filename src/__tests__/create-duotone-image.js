...
describe('createDuotoneImage', () => {
  ...
  it('should throw if no colors are passed', () => {
    expect(() => createDuotoneImage(imageEl))
    .toThrowError('Invalid arguments, You need to pass a primary and secondary color');
  });

  it('should throw if no colors are passed', () => {
    expect(() => createDuotoneImage(imageEl, primaryColor))
    .toThrowError('Invalid arguments, You need to pass a primary and secondary color');
  });

  it('should return a processed image', () => {
    expect(createDuotoneImage(imageEl, primaryColor, secondaryColor)).toMatchSnapshot();
  });
});
